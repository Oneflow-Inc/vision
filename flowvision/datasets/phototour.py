"""
Modified from https://github.com/pytorch/vision/blob/main/torchvision/datasets/phototour.py
"""
import os
...
def read_image_file(data_dir: str, image_ext: str, n: int) -> flow.Tensor:
