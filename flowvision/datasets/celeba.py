"""
Modified from https://github.com/pytorch/vision/blob/main/torchvision/datasets/celeba.py
"""
...
class CelebA(VisionDataset):
    ...
    def __init__(
        ...
        self.identity = flow.as_tensor(identity[mask].values)
        self.bbox = flow.as_tensor(bbox[mask].values)
        self.landmarks_align = flow.as_tensor(landmarks_align[mask].values)
        self.attr = flow.as_tensor(attr[mask].values)
