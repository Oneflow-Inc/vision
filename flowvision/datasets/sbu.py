"""
Modified from https://github.com/pytorch/vision/blob/main/torchvision/datasets/sbu.py
"""
...
class SBU(VisionDataset):
    ...
    def __init__(self, root, transform=None, target_transform=None, download=True):
        ...
        file1 = os.path.join(
            self.root, "dataset", "SBU_captioned_photo_dataset_urls.txt"
        )
        file2 = os.path.join(
            self.root, "dataset", "SBU_captioned_photo_dataset_captions.txt"
        )
    ...
    def download(self):
        ...
        with open(
            os.path.join(self.root, "dataset", "SBU_captioned_photo_dataset_urls.txt")
        ) as fh:
            for line in fh:
                url = line.rstrip()
                try:
