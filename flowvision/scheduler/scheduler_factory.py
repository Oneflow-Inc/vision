"""
Modified from https://github.com/rwightman/pytorch-image-models/blob/master/timm/scheduler/scheduler_factory.py
"""
...
# create scheduler by config system or argparse
