...
class CosineLRScheduler(Scheduler):
    ...
    Args:
        ...
        lr_min: Defaults to 1e-5. The minimum learning rate to use 
            during the scheduling. The learning rate does not ever go below this value.
        decay_rate: When decay rate > 0 and < 1., at every restart 
            the learning rate is decayed by new learning rate which equals ``lr * decay_rate``. 
            If decay_rate=0.5, then in that case, the new learning rate becomes half the initial lr.
