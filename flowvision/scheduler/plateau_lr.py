"""
Modified from https://github.com/rwightman/pytorch-image-models/blob/master/timm/scheduler/plateau_lr.py
"""
...
class PlateauLRScheduler(Scheduler):
    ...
    def __init__(self,
        ...
        self.lr_scheduler = flow.optim.lr_scheduler.ReduceLROnPlateau(
            self.optimizer,
            patience=patience_t,
            factor=decay_rate,
            verbose=verbose,
