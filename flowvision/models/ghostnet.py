...
model_urls = {
    "ghostnet": "https://oneflow-public.oss-cn-beijing.aliyuncs.com/model_zoo/flowvision/classification/MobileNet/mobilenet_v3_large.zip",
}
...
def hard_sigmoid(x, inplace: bool = False):
    if inplace:
        ...
        return F.hardtanh(x+3., min_val=0., max_val=6.)/6.
