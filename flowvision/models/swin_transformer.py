...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        self.relative_position_bias_table = nn.Parameter(
            flow.zeros((2 * window_size[0] - 1) * (2 * window_size[1] - 1), num_heads))  # 2*Wh-1 * 2*Ww-1, nH
        self.relative_position_bias_table.trunc_normal_(std=.02)
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        if self.ape:
            ...
            self.absolute_pos_embed.trunc_normal_(std=.02)
...
def swin_tiny_patch4_window7_224(pretrained=False, progress=True, **kwargs):
    model_kwargs = dict(
        img_size=224, patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 6, 2), num_heads=(3, 6, 12, 24), drop_path_rate=0.2, **kwargs
    )
...
def swin_small_patch4_window7_224(pretrained=False, progress=True, **kwargs):
    model_kwargs = dict(
        img_size=224, patch_size=4, window_size=7, embed_dim=96, depths=(2, 2, 18, 2), num_heads=(3, 6, 12, 24), drop_path_rate=0.3, **kwargs
    )
    return _create_swin_transformer("swin_small_patch4_window7_224", pretrained=pretrained, progress=progress, **model_kwargs)
...
def swin_base_patch4_window7_224(pretrained=False, progress=True, **kwargs):
    ...
    return _create_swin_transformer("swin_base_patch4_window7_224", pretrained=pretrained, progress=progress, **model_kwargs)
...
def swin_base_patch4_window12_384(pretrained=False, progress=True, **kwargs):
    ...
    return _create_swin_transformer("swin_base_patch4_window12_384", pretrained=pretrained, progress=progress, **model_kwargs)
