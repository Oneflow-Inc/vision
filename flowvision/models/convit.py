...
class GPSA(nn.Module):
    ...
    def get_attention(self, x):
        ...
        attn = (1. - flow.sigmoid(gating)) * patch_score + flow.sigmoid(gating) * pos_score
    ...
    def get_rel_indices(self, num_patches):
        ...
        ind = flow.arange(img_size,dtype=flow.float32).view(1, -1) - flow.arange(img_size,dtype=flow.float32).view(-1, 1)
