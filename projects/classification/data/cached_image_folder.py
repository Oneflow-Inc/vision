"""
Modified from https://github.com/microsoft/Swin-Transformer/blob/main/data/cached_image_folder.py
"""
    ...
    def init_cache(self):
        ...
        for index in range(n_sample):
            if index % (n_sample // 10) == 0:
                ...
                print(f'global_rank {flow.env.get_rank()} cached {index}/{n_sample} takes {t:.2f}s per block')
                start_time = time.time()
