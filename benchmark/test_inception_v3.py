...
def test_inception_v3_batch_size16(benchmark):
    benchmark.pedantic(run_inception_v3_batch_size16)
...
def test_inception_v3_batch_size8(benchmark):
    benchmark.pedantic(run_inception_v3_batch_size8)
...
def test_inception_v3_batch_size4(benchmark):
    benchmark.pedantic(run_inception_v3_batch_size4)
...
def test_inception_v3_batch_size2(benchmark):
    benchmark.pedantic(run_inception_v3_batch_size2)
...
def test_inception_v3_batch_size1(benchmark):
    benchmark.pedantic(run_inception_v3_batch_size1)
