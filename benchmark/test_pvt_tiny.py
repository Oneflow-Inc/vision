...
def test_pvt_tiny_batch_size16(benchmark):
    benchmark.pedantic(run_pvt_tiny_batch_size16, rounds=50)
...
def test_pvt_tiny_batch_size8(benchmark):
    benchmark.pedantic(run_pvt_tiny_batch_size8, rounds=50)
...
def test_pvt_tiny_batch_size4(benchmark):
    benchmark.pedantic(run_pvt_tiny_batch_size4, rounds=50)
...
def test_pvt_tiny_batch_size2(benchmark):
    benchmark.pedantic(run_pvt_tiny_batch_size2, rounds=50)
...
def test_pvt_tiny_batch_size1(benchmark):
    benchmark.pedantic(run_pvt_tiny_batch_size1, rounds=50)
